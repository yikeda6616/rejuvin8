...
<html>
  <head>
    ...
    />
    <link
      href="https://fonts.googleapis.com/css?family=Libre+Baskerville:400,700|Open+Sans:300,400,700"
      rel="stylesheet"
    />
    <link
      rel="stylesheet"
    ...
    <div class="wrapper">
      ...
      <section class="operations section no-padding" id="services">
        <div class="container-fluid">
          <div class="row no-gutter">
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 imagePanel--outer">
            ...
            <div
              class="col-xl-3 col-lg-6 col-md-6 col-ssm-12 imagePanel--outer"
            >
              <div class="imagePanel">
                <a class="imagePanel__box" href="#services"
